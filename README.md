...
* #### A. First Time Visitor
    ...
    3. As a First Time  Visitor, I want to be able to view the gallery to look at the artist portfolio.
...
* #### B. Returning Visitor
    ...
    2. As a Returning Visitor, I want to be able to give feedback or ask question to the business owner.
    3. As a Returning Visitor, I want to be able to find what other services is provided in addtion to the ones I already know.
...
* **F01 - Navigation Bar**
    * The navigation bar is placed one all the three pages of the website to provide user with a cohesive and coherent feel to the website. It includes the logo of the business, Home, Services, Gallery, Contact, and Download Brochure button. The navigation bar is fully responsive on both larger and smaller screen size. On smaller screen size, the menus and the "download" button are located under the logo.
    * The contrasting, bright colour download button is place separate on the right hand side of the screen to make it eye-catching, so the user can go straight to download the brochure if the needed.
        * This download button doesn't actually download, but rather take the user to the contact page's Brochure section. This is to provide the business a way to collect information from the user for marketing purposes.
        * The download button also has an effect when the user hover their cursor on top to provide a visual guide and a more fun and interractive user experience.
...
* **F04 - Services**
    * The Services section is there to layout different types of services provided by the business.
    * The alternating colourc is there to help separate each data in the table and made it more visually appealing.
    * This section is presented in 3 separate inline tables on larger screen. On smaller screen the tables follows one another vertically.
...
* **F05 - Footer**
    ...
    * The Footer consits of the social links to the business social pages and a copyright.
...
* **F06 - Gallery**
    ...
    * The Gallery is laid out in a symmetrical 3x3 layout. This is to provide plenty of space for user to view the images.
    * The images is in the Gallery also has a hover effect, which give the Gallery a more fun and interractive user experience.
    * The Gallery is fully responsive and will show one image at a time on smaller screen size. This is to also give user a better look at the image without overcrowding the smaller screen size

    ![Gallery](documentation/support-images/f06-gallery.png)

* **F07 - Contact Page Hero Image**
    * The Contact page also feature a hero image. This is done so that the website feels consistent with the other pages.
...
* **F09 - Submitted Page**
    * The Submitted Page replaces the form when the user submits the form. This is to give the user a visual promt that their information has been submitted.
...
* **F10 - Brochure Download Button**
    ...
    * This button is also essential for users who's browser do not support iFrames, since they can download the brochure and open on their devices if the iFrame does not show up.

    ![BrochureDownload](documentation/support-images/f10-brochure-download.png)

* **F11 - Brochure iFrame**
    * The iFrame is placed to provide user who does not like to download things to their devices or find downloading unncessary. They can have a quick glance of the brochure via the iFrame. Which aim is also to provide a better and interractive user experience.
...
*   The hero image was chosen because it features the owner of the business, Jose, standing in a room that he personally renovated, showcasing his expertise in interior design. The colours and patterns used in the room are also a prominent feature in the image, which helps to highlight Jose's unique style and artistic flair. The fact that the image is eye-catching and fun further help drawing the user's attention to the page and would help develop an emotional attachment to the business.

### Colour Scheme

* The colour scheme is provide by the client. The two original colours are #81a97b and #f4d455. #ffb30f was later chosen due to the fact that #f4d455 was too light.

    ![colour Scheme](documentation/support-images/sotofox-colours.png)

### Typography

* The orginal font provide by the client is 'Chewy' and 'Tenor Sans', but the client allow for personal freedom for the developer to select alternative font style. The font that was chosen are 'Gafata' and 'Text Me One'. They were selected because they work well together and provide a modern feel to the website.

### Wireframe

* Wireframe were created via Balsamiq
...
### Framworks, Libraries & Other Tools Used
...
*   [Font Awesome:](https://fontawesome.com/) was used to add icon to convey the message of the sections and for aesthetic purposes of the UX
*   [Git:](https://git-scm.com/) was used for version controlling purposes through git commands via the terminal on GitPod and is pushed to GitHub for cloud-based storing.
*   [GitHub:](https://github.com/) is used to host the repository of the project and also used for deployment of the website.
*   [Figma:](https://www.figma.com/) was used to create wireframe during the initial design process.
*   [Balsamiq:](https://balsamiq.com/) was also used to create wireframe during the initial design process.
*   [Favicon.io:](https://favicon.io/) was used to generate a Favicon (a website icon that appears in the tab of the broswer or when the website is saved to the bookmark bar) for the website.
...
*   [Fontjoy:](https://fontjoy.com/) was used to generate font that pair wells together.
...
* The table below has listed all the test cases and details of how the test was performed and the result of the test is cross reference with the Feature ID of each features.
...
* This website is deployed via GitHub Pages
    * From the GitHub Repositiory, nagivigate to the Settings tab, and select Pages from the menu on the left.
    * From there under the Branch section, select the Main branch and /root directory, and save your selection.
    * Once saved, GitHub will take a couple minutes to host the website on their GitHub Pages service.
...
* General inspiration of the website's layout comes from [Charlotte The Decorator](https://github.com/SamarZiadat/charlotte-the-decorator)
...
* Colour scheme of the website is based on the colour that is provided by the client
